...
% TODO: Is this story reasonable? 
% TODO: Check the interactivity things.
% TODO: non-adaptive
...
For each such line, the grader will in response write a single line with the integer \texttt{a[x][y][z]}, which can be read from standard input by your program.
...
% C++: cout << endl, or fflush(stdout) if using printf
% Pascal: Flush(Output);
