...
\newcommand{\testgroups}{
Deine Lösung wird auf mehreren Testgruppen getestet werden, von denen jede eine bestimmte Punktzahl wert ist.
Jede Testgruppe enthält einige Testcases. Um Punkte für eine Testgruppe zu bekommen, müssen alle Testfälle in der entsprechenden Gruppe gelöst werden.
}
